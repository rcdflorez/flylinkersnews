...
<div class="wrap">
	...
	<h2><?php _e( 'Post Category Image With Grid and Slider with ', 'post-category-image-with-grid-and-slider' ); ?><span class="wpos-epb"><?php _e( 'Essential Plugin Bundle', 'post-category-image-with-grid-and-slider' ); ?></span></h2><br />
		...
		<div id="post-body" class="metabox-holder columns-2">
				...
				<table class="wpos-plugin-pricing-table">
				    ...
				    <thead>
				    	<tr>
				    		...
				    		<th>
				    			...
				    			<p>Gain access to <strong>Post Category Image With Grid and Slider</strong> included in <br /><strong class="wpos-epb">Essential Plugin Bundle</strong></p>
				    			<a href="<?php echo PCIWGAS_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Post-Category-Image&utm_campaign=Upgrade-PRO" target="_blank">Buy Now</a>
				    		</th>	    		
				    	</tr>
				    </thead>
				    ...
				    <tfoot>
				    	<tr>
				    		<th></th>
				    		<td></td>
				    		<td><p>Gain access to <strong>Post Category Image With Grid and Slider</strong> included in <strong>Essential Plugin Bundle</strong></p>
							<a href="<?php echo PCIWGAS_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Post-Category-Image&utm_campaign=Upgrade-PRO" class="wpos-button" target="_blank">Buy Now</a></td>
				    	</tr>
				    </tfoot>
			...
			<div id="postbox-container-1" class="postbox-container wpos-sidebar">
				<div class="wpos-epb-wrap">
					...
					<ul>
						<li><b>40+ Utility Plugins</b> including <span><?php echo PCIWGAS_NAME; ?> premium </span> version.</li>
					...
					<a class="button-yellow button-orange" style="margin-bottom:0px;" href="<?php echo PCIWGAS_SITE_LINK; ?>/essential-bundle/?utm_source=WP&utm_medium=Post-Category-Image&utm_campaign=EPB-Upgrade-PRO" target="_blank">Buy Now</a>
				</div>
