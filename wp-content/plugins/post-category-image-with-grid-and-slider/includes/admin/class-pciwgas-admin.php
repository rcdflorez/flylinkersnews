...
class Pciwgas_Admin {
	...
	function pciwgas_register_menu() {
		...
		add_submenu_page( 'pciwgas-settings', __('Upgrade to PRO - Post Category Image With Grid and Slider', 'post-category-image-with-grid-and-slider'), '<span style="color:#ff2700">'.__('Upgrade to PRO', 'post-category-image-with-grid-and-slider').'</span>', 'manage_options', 'pciwgas-premium', array($this, 'pciwgas_premium_page') );
	}
