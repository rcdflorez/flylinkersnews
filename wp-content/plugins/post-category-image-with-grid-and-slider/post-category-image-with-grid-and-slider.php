...
if( !defined( 'PCIWGAS_VERSION' ) ) {
	define( 'PCIWGAS_VERSION', '1.4.3' ); // Version of plugin
}
...
if( !defined( 'PCIWGAS_PLUGIN_LINK' ) ) {
    define( 'PCIWGAS_PLUGIN_LINK', 'https://www.essentialplugin.com/pricing/?utm_source=WP&utm_medium=Post-Category-Image&utm_campaign=Features-PRO' ); // Plugin link
}
